  ...
  return (
    <div className={cn('relative', sizeClasses[size], className)}>
      ...
      <div
        ...
        className={cn(
          'relative rounded-full overflow-hidden border-2 border-dashed border-border cursor-pointer transition-all hover:border-primary',
          sizeClasses[size],
